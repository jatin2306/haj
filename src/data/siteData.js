...
export const HAJJ_PACKAGES = [
  {
    ...
    tier: 'Deluxe',
    dates: 'Hajj 1448 / 2027',
    madinah: 'Emaar Royal Hotel Medina (or similar) — half board, near Masjid an-Nabawi',
    makkah:
      'Suites Almaqam (Mashaeer, full board, 15–20 min from Al-Jamarat) & Anjum Hotel Makkah (half board, steps from the Haram). Hotel shifting applies during Hajj.',
    includes: [
      'Return flight',
      'Hotels in Makkah & Madinah',
      'Complete Mashaeer support',
      'All ground transport',
      'Room sharing availability',
      'Expert guidance & 24/7 on-ground assistance',
      'Special assistance for Bangladesh passport holders',
    ],
    prices: { quad: 8749, triple: 9349, twin: 9949 },
    deposit: 1000,
    breakfast: false,
    mealNote: 'Half board & full board as per hotel itinerary',
    kids: 'Prices per person. Qurbani not included.',
    flightsNote: null,
    earlyBird: null,
  },
  {
    ...
    tier: 'Luxury',
    dates: 'Hajj 1448 / 2027',
    madinah: 'Worth Peninsula Madinah (or similar) — half board, near Masjid an-Nabawi',
    makkah:
      'Suites Almaqam (Mashaeer, full board, 15–20 min from Al-Jamarat) & Hyatt Regency Jabal Omar (half board, steps from the Haram). Hotel shifting applies during Hajj.',
    includes: [
      'Return flight',
      'Hotels in Makkah & Madinah',
      'Complete Mashaeer support',
    ...
    prices: { quad: 9849, triple: 10449, twin: 11449 },
    deposit: 1000,
    breakfast: false,
    mealNote: 'Half board & full board as per hotel itinerary',
    kids: 'Prices per person. Qurbani not included.',
...
export const UMRAH_PACKAGES = [
  {
    ...
    flightsNote: FLIGHTS_NOT_INCLUDED,
    earlyBird: null,
  },
  {
    id: '5-star-aug-2026',
  ...
  },
  {
    ...
    includes: [
      'Flights with Qatar Airways (2pc 35 kg luggage allowance)',
      'Guided ziyarah tours in Makkah',
      'Guided ziyarah tours in Madinah',
      'ETA visa (British passport)',
      'Full ground transport',
